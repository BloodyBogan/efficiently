...
CREATE TABLE user_role (role_id INT PRIMARY KEY, role VARCHAR(13) NOT NULL UNIQUE);

INSERT INTO user_role (role_id, role) VALUES (1, 'student'), (2, 'correspondent'), (3, 'admin');
